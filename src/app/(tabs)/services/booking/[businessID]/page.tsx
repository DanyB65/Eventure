...
export default function BusinessBooking({}){
        ...
        console.log(id)
        const selectedBusiness = fakeData.find(business => business.id.toString() === id);
    ...
    return (
              <>
                ...
                <TimePicker/>
                {selectedBusiness ? (
                  <div className="p-4 bg-cream"> {/* Ajout d'un padding et d'un fond crème pour plus de lisibilité */}
                    <h1 className="text-black text-xl font-bold">Booking for Business ID: {selectedBusiness.id}</h1>
                    <h2 className="text-black text-lg">Title: {selectedBusiness.title}</h2>
